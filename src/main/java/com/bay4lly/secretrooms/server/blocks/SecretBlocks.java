...
public class SecretBlocks {
    ...
    public static final DeferredHolder<Block, Block> SECRET_DUMMY_BLOCK = REGISTRY.register("secret_dummy_block", () -> new SecretBaseBlock(Block.Properties.of().mapColor(MapColor.STONE).noOcclusion().lootFrom(() -> Blocks.AIR)));
